...
const List<_Ach> _kAch = [
  ...
  _Ach('Perfectionist',       '50 flawless solves (no backtrack)','worldline',  'perfect',    50),
  _Ach('Explorer',            'Discover all five mechanics',      'objects',    'mechanics',  5),
  _Ach('Wormhole Navigator',  'Clear 25 wormhole regions',        'wormhole',   'wormhole',   25),
  _Ach('Locksmith',           'Clear 25 mass-gate regions',       'gate',       'gate',       25),
  _Ach('Slingshot',           'Clear 25 gravity-well regions',    'well',       'well',       25),
  _Ach('Quantum Observer',    'Measure 25 entangled regions',     'entangled',  'entangled',  25),
  _Ach('Multiverse Traveller','Traverse 25 multiverse regions',   'multiverse', 'multiverse', 25),
  _Ach('Heat-Death Defier',   'Reach Entropy Lv 20',              'entropy',    'entropy',    20),
